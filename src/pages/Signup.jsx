...
const Signup = () => {
  ...
  return (
    <section className="min-h-screen md:h-screen lg:h-screen xl:h-screen  w-auto px-2 pb-4 text-gray-400 bg-gray-900 body-font">
      ...
      <div className="w-full h-full py-6 mx-auto md:w-3/5 lg:w-2/5">
        <h1 className="mb-1 text-gray-300 text-xl font-medium text-center  md:text-3xl font-body">Create your Free Account</h1>
        <Link to='/login' >
        ...
        <form className="mt-12 space-y-4 w" onSubmit={handleSubmit}> 
            {/* <div className='block'>
                <label className='block font-body mb-1 text-sm font-medium text-gray-400'>Name : </label>
                <input  className='w-full font-body bg-gray-600 bg-opacity-20 focus:bg-transparent focus:ring-2 focus:ring-indigo-900 rounded border border-gray-600 focus:border-indigo-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out' value={name} onChange={e => setName(e.target.value)} />
            </div>

            <div className='block'>
                <label className='block font-body mb-1 text-sm font-medium text-gray-400'>Surname : </label>
                <input  className='w-full font-body bg-gray-600 bg-opacity-20 focus:bg-transparent focus:ring-2 focus:ring-indigo-900 rounded border border-gray-600 focus:border-indigo-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out' value={surname} onChange={e => setSurname(e.target.value)} />
            </div> */}
